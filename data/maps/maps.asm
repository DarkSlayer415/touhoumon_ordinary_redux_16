...
MapGroup_Dungeons:
	...
	map SilverCaveRoom1, TILESET_ICE_PATH, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map RockTunnelB1F, TILESET_ICE_PATH, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
