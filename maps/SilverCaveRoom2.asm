...
SilverCaveRoom2_MapEvents:
	...
	object_event  3, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2RareCandy, EVENT_SILVER_CAVE_ROOM_2_RARE_CANDY
